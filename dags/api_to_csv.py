...
from s3_file_sender import local_to_s3, remove_local_file
...
with DAG('api_to_csv', schedule_interval='@daily', default_args=default_args, catchup=False, start_date=datetime.now()) as dag :
